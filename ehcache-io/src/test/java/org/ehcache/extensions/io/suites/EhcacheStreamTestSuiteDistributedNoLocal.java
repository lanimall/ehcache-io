...
public class EhcacheStreamTestSuiteDistributedNoLocal extends EhcacheStreamTestSuiteBase {
    @BeforeClass
    public static void setup() throws Exception {
        EhcacheStreamTestSuiteBase.setup();
        System.setProperty(EhcacheStreamingTestsBase.ENV_CACHETEST_TYPE, EhcacheStreamingTestsBase.CacheTestType.CLUSTERED_STRONG_NOLOCAL.getPropValue());
    }
